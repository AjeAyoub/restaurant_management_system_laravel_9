...
<x-guest-layout>
     ...
     <h1
         class="font-mono text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-green-500 md:text-center sm:leading-none lg:text-5xl">
         ...
         > -->
             ...
             <div class="w-full md:w-1/2">
                 <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                     <img src="https://cdn.pixabay.com/photo/2017/03/10/13/57/cooking-2132874_960_720.jpg" />
                 </div>
             </div>
         </div>
     </div>
     ...
     <div class="container items-center max-w-6xl px-4 px-10 mx-auto sm:px-20 md:px-32 lg:px-16">
         <div class="flex flex-wrap items-center -mx-3">
             ...
             <div class="w-full px-3 mb-12 lg:w-1/2 order-0 lg:order-1 lg:mb-0"><img
                     ...
                     src="https://cdn.pixabay.com/photo/2021/09/20/06/55/spaghetti-6639970_960_720.jpg"
 ...
 <section class="pt-4 pb-12 bg-gray-800">
     ...
     <div class="grid gap-2 lg:grid-cols-3">
         ...
         <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
             ...
             <div class="flex justify-end mt-4">
                 <a href="#" class="text-xl font-medium text-green-500">Fadma Anflousse</a>
             </div>
         </div>
     </div>
 </section>
